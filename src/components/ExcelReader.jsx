...
const ExcelReader = () => {
  ...
  const fetchExcelData = async () => {
    try {
      ...
      const response = await fetch(
        "resources/data/GokraFamilyDatabase.xlsx?timestamp=" +
          new Date().getTime()
      );
  ...
  return (
    <div>
      ...
      <div className=" flex flex-row items-center justify-center  bg-black-500 pr-4 ">
        <br />
        <button
          className="bg-green-500 hover:bg-blue-700 text-white font-bold italic py-2 px-4 rounded ml-4 items-end"
          onClick={handleClick}
          // style={{ right: "0px" }}
        >
